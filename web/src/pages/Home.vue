    ...
    <el-row :gutter="40" class="panel-group">
      <el-col :span="6" class="card-panel-col">
        <div class="card-panel" v-on:click="jump('/admin/user/online')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">Users online</div>
      ...
      <el-col :span="6" class="card-panel-col">
        <div class="card-panel" v-on:click="jump('/admin/group/list')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">Total groups</div>
      ...
      <el-col :span="6" class="card-panel-col">
        <div class="card-panel" v-on:click="jump('/admin/user/ip_map')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">Total IP mapping</div>
...
export default {
  ...
  created() {
    ...
    this.$emit('update:route_name', ['Home'])
  },
  mounted() {
    this.getData()
    this.getGroups()
